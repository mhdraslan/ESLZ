...
module createRouteTables 'br/public:avm/res/network/route-table:0.3.0' = [for udr in routeTables: {
  name: udr.name
...
module createNetworkSecurityGroups 'br/public:avm/res/network/network-security-group:0.4.0' = [for nsg in networkSecurityGroups: {
...
/*
module createSubnets 'br/public:avm/res/network/virtual-network:0.2.0' = [for vnet in virtualNetworks: {
  name: 'test'
  scope: resourceGroup(vnet.resourceGroup)
  params:[]
}]
