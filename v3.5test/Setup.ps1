...
#>
New-AzTenantDeployment -Name "eslz-test-01" -Location 'UAE North' -TemplateUri "https://raw.githubusercontent.com/mhdraslan/ESLZ/main/v3.5test/Master/main.json" -TemplateParameterUri "https://raw.githubusercontent.com/mhdraslan/ESLZ/main/v3.5test/Master/main.param.json"
